...
export default function CreateTickets() {
    ...
    const [activeTicketType, setActiveTicketType] = useState<null | string>(null)
    console.log('activeTicketType', activeTicketType);
    ...
    const handleDrawer = (name: string) => {
        setIsOpen((prevState) => !prevState)
        setActiveTicketType(name.toLowerCase())
    }
    return (
        <div className='editor_title' >
            ...
            <TicketModal type={activeTicketType} isOpen={isOpen} toggleDrawer={toggleDrawer} />
        </div>
    )
}
