        ...
        <div className='editor_title' >
            ...
            <div className="ticket_list">
                {ticketTypes.map(({ name, description, icon }) =>
                    <div className="ticket_item" key={name}>
                        {icon}
                        <div>
                            <h3>{name}</h3>
                            <p>{description}</p>
